...
public class LokasiListParameter extends ListActivity {
String ip="";
...
String deskripsi;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.lokasi_list);
		arrayList = new ArrayList<HashMap<String, String>>();
		ip=jParser.getIP();


		Button parameter=(Button) findViewById(R.id.btnParameter);
		parameter.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				Intent i = new Intent(LokasiListParameter.this,listParameter.class);
...
//		new load().execute();
		...
		ListAdapter adapter = new SimpleAdapter(LokasiListParameter.this, arrayList,R.layout.desain_list, new String[] { TAG_kode_lokasi,TAG_nama_lokasi,TAG_kategori},new int[] { R.id.kode_k, R.id.txtNamalkp, R.id.txtDeskripsilkp});
